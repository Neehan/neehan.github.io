...
4. Under pre-layer normalization, token representations are approximately white across features. Consequently, the scaled attention logits $QK^T/\sqrt{d}$ approximates the pairwise correlation between tokens.
